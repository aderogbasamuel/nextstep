...
const eligibility = [
  ["Computer Engineering", "You meet this requirement.", "good"],
  ["Undergraduate student", "You meet this requirement.", "good"],
  ["Nigeria", "You meet this requirement.", "good"],
  ["2+ years experience", "This requirement may need review.", "warn"],
  ["Python", "You don't currently have this skill listed.", "bad"],
];
const tasks = [
  "Review eligibility",
  "Prepare CV",
        ...
        <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
          <div>
            <div className="flex items-center gap-2 text-xs font-medium text-blue-600">
              ...
              Internship · Demo analysis
            </div>
            <h1 className="mt-3 text-3xl font-bold tracking-tight">
              Software Engineering Internship
            </h1>
            <p className="mt-2 text-sm text-slate-500">
              FutureTech Labs · Analyzed today, September 24, 2026
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.78fr_1.22fr]">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <div className="mt-5 grid gap-3">
              {eligibility.map(([title, body, status]) => (
                <div
                  key={title}
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">3 of 6 complete</p>
              </div>
              <div className="w-28">
            ...
            <div className="mt-6 grid gap-1">
              {tasks.map((task, i) => (
                ...
                >
                  ...
                  <span
                    className={`text-sm ${i < 3 ? "text-slate-500 line-through" : "font-medium text-slate-800"}`}
                  >
                    {task}
                  </span>
                </div>
              ...
              <div className="mt-4 grid gap-3">
                <div className="rounded-lg border border-slate-100 p-3">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Required skill · Not listed
                  </p>
                </div>
                <div className="rounded-lg border border-slate-100 p-3">
                  <p className="text-sm font-medium">Recommendation letter</p>
                  <p className="mt-1 text-xs text-slate-500">
