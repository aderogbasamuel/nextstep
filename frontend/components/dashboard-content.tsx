...
const recent = [
  ...
  {
    title: "African Technology Scholarship",
    type: "Scholarship",
    match: "92%",
    status: "Eligible",
    date: "Yesterday",
  ...
  return (
    <AppShell>
      <main className="mx-auto max-w-7xl px-5 py-9 lg:px-10 lg:py-11">
        <PageHeader
          eyebrow="Monday, September 24, 2026"
          title={`Good morning, ${name.split(" ")[0]}`}
          description="Here's what needs your attention today."
        />
        <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {[
            ["Analyses", "24", FileText, "All opportunities"],
            ["Eligible", "17", CheckCircle2, "71% of analyses"],
            ["Needs review", "4", Clock3, "Worth a closer look"],
            ["Deadlines", "3", CalendarDays, "Next 30 days"],
